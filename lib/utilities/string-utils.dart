...
class StringUtils {
  ...
  static int timeOfDayToMillisecondsSinceEpoch(TimeOfDay timeOfDay) {
    final int hoursInMilliseconds = timeOfDay.hour * 60 * 60 * 1000;
    final int minutesInMilliseconds = timeOfDay.minute * 60 * 1000;
    return hoursInMilliseconds + minutesInMilliseconds;
  }


  static int dateAndTimeToMillisecondsSinceEpoch(TimeOfDay timeOfDay, DateTime date) {
  ...
  static List<Position> coordinatesToPositions(List<List<double>> coordinates) {
  ...
  static Position centerToPositions(List<double> coordinates) {
